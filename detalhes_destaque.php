...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT nome, descricao, preco, disponibilidade, imagem1, imagem2, imagem3 FROM detalhes_destaque WHERE id = $id";
...
<style>
    ...
    .btn {
        ...
        color: #fff;
        border: none;
        border-radius: 5px; cursor: pointer; } </style><script>
